...
public class Character : MonoBehaviour
{
	...
	[SerializeField] SkillList Skills;
	[SerializeField] CharacterEquipmentController equipmentController;
	...
	private void Awake()
	{
		...
		equipmentController = GetComponent<CharacterEquipmentController>();
